    ...
    function __chart(context){
        ...
        this.Line = function(data,options){
            ...
            chart.Line.defaults = {
                ...
                scaleStepWidth : 20,
                scaleStartValue : 20,
                scaleLineColor : Styles.gridlinesColor,
                scaleLineWidth : getActualD(1),
                scaleShowLabels : true,
                scaleLabel : "<%=value%>",
                scaleFontFamily : Styles.fontMrR.name,
                scaleFontSize : getActualD(9),
                scaleFontStyle : "normal",
                scaleFontColor : Styles.textColor1,
                scaleShowGridLines : true,
                scaleGridLineColor : Styles.gridlinesColor,
                scaleGridLineWidth : getActualD(1),
                bezierCurve : false,
                pointDot : true,
                pointDotRadius : getActualD(3),
                pointDotStrokeWidth : 0,
                datasetStroke : true,
                datasetStrokeWidth : getActualD(2),
                datasetFill : true,
                animation : true,
                animationSteps : 60,
                animationEasing : "easeOutQuart",
